...
public class ClientOptionItem
{
        ...
        Action additionalOnClickAction = null)
    {
        try
        {
            ...
            {
                CustomBackground = UnityEngine.Object.Instantiate(optionsMenuBehaviour.Background, optionsMenuBehaviour.transform);
            ...
            ToggleButton = UnityEngine.Object.Instantiate(mouseMoveToggle, CustomBackground.transform);
